//  Created by Jesse Jones on 6/20/20.
//  Copyright © 2020 MushinApps. All rights reserved.
import Foundation

// I haven't found any persistence or serialization libraries with good support for forward
// compatibility (usually this is synthesizing missing fields but sometimes more complex
// logic is needed to deal with schema changes). So we use these wrappers around Codable
// to support that at the cost of having to write quite a bit of boiler-plate code.
